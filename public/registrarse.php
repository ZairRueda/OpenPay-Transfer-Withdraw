...
<body>
    ...
    <main>
        <section class="registro">
            ...
            <form action="register.js" class="box" onsubmit="return validar();">
                <input type="text" id="mail" name="mail" placeholder="Mail" required>
                <input type="text" id="usrname" name="usuario" placeholder="Usuario" required>
                ...
                <p class="registrate"> ¿Ya tienes una cuenta? <a class="link" href="sesion.php">Iniciar sesión</a></p>
                <div id="mensaje">
